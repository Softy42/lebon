...
<head>
  ...
  <style>
    ...
    .mag-banner{width:min(920px,calc(100% - 2.5rem));margin:.7rem auto 0;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:.75rem 1rem;display:flex;justify-content:space-between;align-items:center;gap:.75rem;box-sizing:border-box}
